...
++  on-poke
  ...
  ?+  mark  (on-poke:def mark vase)
    ...
    ?:  &(=(%'POST' method.request.inbound-request) =(path-tape "/apps/calendar/api/event"))
      ...
      [(give-simple-payload:app:server eyre-id simple-payload) this(events (~(put by events.state) key raw))]
