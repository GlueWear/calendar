...
++  on-poke
  ...
  ?+  mark  (on-poke:def mark vase)
    ...
    ?:  &(=(%'GET' method.request.inbound-request) =(path-tape "/apps/calendar/api/debug"))
      ...
      =.  dbg  :(weld dbg (trip '","version":"365K-propagation-fix-4","events":') (trip evs))
